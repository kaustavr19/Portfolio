...
export type TOD = "pre-dawn" | "morning" | "noon" | "afternoon" | "sunset" | "night";

export function getTOD(h: number): TOD {
...
export const CFG: Record<TOD, Cfg> = {
  "pre-dawn": {
...
export function AnimatedWallpaper({ cfg }: { cfg: Cfg }) {
  return (
